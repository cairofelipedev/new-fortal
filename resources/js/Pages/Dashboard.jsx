    ...
    return (
        ...
        >
            ...
            <div class={`${style.gridInfos}`}>
                <Link href="/dashboard/espacos-de-eventos">
                    <div class={`${style.article} bg-white rounded-[20px] shadow-lg text-gray-700`}>
                        ...
                        <div className={style.areaInfo}>
                            <p className={style.infoLabel}>
                                <span class="font-semibold">Cadastros Totais</span>
                                <b>9</b>
                            </p>
                            <p className={style.infoLabel}>
                ...
                <Link href="/dashboard/leads">
                    <div class={`${style.article} bg-white rounded-[20px] shadow-lg text-gray-700`}>
                        ...
                        <div className={style.areaInfo}>
                            ...
                            <p className={style.infoLabel}>
                                <span class="font-semibold">Leads impulsionados</span>
                                <b>2 Leads</b>
                            </p>
                            <p className={style.infoLabel}>
                                <span class="font-semibold">Status</span>
                                <b>2 Leads não respondidos</b>
                            </p>
                        </div>
                        <button class={`${style.button} bg-teal-500 text-white w-full py-2 hover:bg-teal-600 transition`}>
                            Acessar
                ...
                <Link href="#">
                    <div class={`${style.article} bg-white rounded-[20px] shadow-lg text-gray-700`}>
                        ...
                        <div className={style.areaInfo}>
                            <p className={style.infoLabel}>
                                <span class="font-semibold">Eventos Totais 2025</span>
                                <b>10 Eventos</b>
                            </p>
                            <p className={style.infoLabel}>
                                <span class="font-semibold">Eventos Destaques</span>
                                <b>2 Eventos</b>
                            </p>
                            <p className={style.infoLabel}>
                                <span class="font-semibold">Promoções</span>
                                <b>8 Promoções</b>
                            </p>
                        </div>
                        <button class={`${style.button} bg-teal-500 text-white w-full py-2 hover:bg-teal-600 transition`}>
