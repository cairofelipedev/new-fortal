                    ...
                    <div key={space.id} className={style.spaceContainer}>
                        ...
                        <article className={style.cardSpace}>
                            <div className={style.imageArea}>
                                <img
                                    src={space.image ? `/uploads/${space.image}` : 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSVYa88AyMbjn63yCvQ5qPB1GJrLP8H4u1caA&s'}
                            ...
                            <div className={style.infoArea}>
                                <div className={style.titleArea}>
                                    <h1>{space.name}</h1>
                                    <Link href={`/dashboard/espacos-de-eventos/${space.id}`}>
