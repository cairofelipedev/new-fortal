export const SocialMedia = () => {
    ...
    return (
        <div class="flex justify-center gap-5 w-full">
            <a href="https://www.facebook.com/fortalezaconvention" class="flex justify-center items-center text-[#f97316] w-[30px] h-[30px] bg-[#fff] rounded-full hover:text-gray-500">
