    ...
    return (
        <section className={style.container}>
            ...
            <div className={`${style.infoArea} lg:grid lg:grid-cols-3 gap-10 space-y-5`}>
                <div>
                    <img src="./images/news/2_Easy-Resize.com.jpg" className="rounded-lg" alt="Imagem Inicial" />
                </div>
                <div>
                    <h1 className="font-neulis">Conheça <b>Fortaleza</b></h1>
                    <p className='text-justify'>Terra onde o sol brilha o ano todo e as oportunidades de networking florescem em um ambiente acolhedor, dinâmico e diversificado. Aqui, você encontrará um destino completo para o turismo de negócios e eventos, unindo uma infraestrutura robusta, conectividade e uma boa oferta de lazer em horários diferenciados. Essa combinação torna Fortaleza um destino onde o trabalho e o bem-estar se encontram.</p>
                </div>
                <img className="rounded-lg" src="./images/news/6_Easy-Resize.com.jpg" alt="Images FLutuantes" />
            </div>
        </section>
    )
}