    ...
    return (
        <section className={style.container}>
            ...
            <div className={style.infoArea}>
                ...
                <p>Terra onde o sol brilha o ano todo e as oportunidades de negócios florescem em um ambiente acolhedor, dinâmico e diversificado. Neste portal vamos te apresentar um destino completo para o turismo de negócios, unindo uma infraestrutura robusta, conectividade e uma boa oferta de lazer em horários diferenciados. Essa combinação torna Fortaleza um destino onde o trabalho e o bem-estar se encontram.</p>
