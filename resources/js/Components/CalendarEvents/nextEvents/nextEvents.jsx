    ...
    return (
        <section className={style.container}>
            ...
            >
                <SwiperSlide>
                    <Card
                        img={'./images/algodao.png'}
                        alt={'imagem clima quente'}
                        name={'Congresso Brasileiro de Algodão'}
                        description={'3 e 5 de setembro de 2024'}
                    />
                </SwiperSlide>
                <SwiperSlide>
                    <Card
                        img={'./images/expolog.png'}
                        alt={'imagem clima quente'}
                        name={'EXPOLOG 2024 - 19 edição'}
                        description={'27 e 28 Novembro 2024'}
                    />
                </SwiperSlide>
                <SwiperSlide>
                    <Card
                        img={'./images/expofavela.png'}
                        alt={'imagem clima quente'}
                        name={'Expo Favela 2024'}
                        description={'06, 07 e 08 de Dezembro 2024'}
                    />
                </SwiperSlide>
                <SwiperSlide>
                    <Card
                        img={'./images/53folac.png'}
                        alt={'imagem clima quente'}
                        name={'Banho de mar cheio'}
                        description={'15 a 18 de Janeiro 2025'}
                    />
                </SwiperSlide>
            </Swiper>
        </section>
    ...
    return (
        <article className={style.card}>
            ...
            <div className={style.areaImage}>
                <img src={img} alt={alt}  className="object-cover h-40 w-full"/>
{/* 
