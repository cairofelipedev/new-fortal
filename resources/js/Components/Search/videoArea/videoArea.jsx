    ...
    return (
        <section className={style.container}>
            ...
            <div className={style.infoArea}>
                ...
                <h2 className={style.title}>Bem vindo a <b>Fortaleza</b><br />onde o trabalho e o Bem estar se encontram</h2>
                <p className={style.description}>Essa combinação torna Fortaleza um destino onde o trabalho e o bem-estar se encontram.</p>
