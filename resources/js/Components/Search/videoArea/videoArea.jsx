import style from './videoArea.module.scss'
    ...
    return (
        <section className={`${style.container}`}>
            ...
            <div className={style.infoArea}>
                ...
                <h2 className={`text-4xl ${style.title}`}>Planeje seu <b>evento</b></h2>
                ...
                {/* <ul className={style.differencils}>
                    <li>
                        ...
                        Atividades de Lazer e Teambuilding
                    </li>
                    <li>
